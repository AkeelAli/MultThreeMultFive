...
public class MultThreeMultFive {
	 ...
	 * If the number is a multiple of 3, return "MultThree"
	 * If the number is a multiple of 5, return "MultFive"
	 * If the number is a multiple of 3 and 5, return "MultThreeMultFive"
